 ...
 * is deployed on rajkeshwar.github.io. This avoids sending events and page views during development.
 */
@Injectable()
export class Analytics {
  ...
  constructor(private _location: Location, private _router: Router) {
    this._enabled = window.location.href.indexOf('rajkeshwar.github.io') >= 0;
  }
