...
```js
import {NgbModule} from '@ng2v/ng2v-components';
```
...
```js
map: {
  '@ng2v/ng2v-components': 'node_modules/@ng2v/ng2v-components/bundles/ng-bootstrap.js',
}
```
## Supported browsers
...
## To check format
node node_modules\clang-format\index.js -i -style="file" src\tabset\tabset.spec.ts
