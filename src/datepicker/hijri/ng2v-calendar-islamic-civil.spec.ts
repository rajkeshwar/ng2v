import {Ng2vCalendarIslamicCivil} from './ng2v-calendar-islamic-civil';
import {Ng2vDate} from '../ng2v-date';

describe('ng2v-calendar-islamic-civil', () => {
  const DATE_TABLE = [
  ...
  const calendar = new Ng2vCalendarIslamicCivil();
  describe('toGregorian', () => {
    DATE_TABLE.forEach(element => {
      let iDate = new Ng2vDate(element[0], element[1], element[2]);
  ...
  it('should return day of week', () => {
    expect(calendar.getWeekday(new Ng2vDate(1437, 12, 15))).toEqual(7);
    expect(calendar.getWeekday(new Ng2vDate(1437, 12, 16))).toEqual(1);
    expect(calendar.getWeekday(new Ng2vDate(1437, 12, 17))).toEqual(2);
    expect(calendar.getWeekday(new Ng2vDate(1437, 12, 18))).toEqual(3);
    expect(calendar.getWeekday(new Ng2vDate(1437, 12, 19))).toEqual(4);
    expect(calendar.getWeekday(new Ng2vDate(1437, 12, 20))).toEqual(5);
    expect(calendar.getWeekday(new Ng2vDate(1437, 12, 21))).toEqual(6);
    expect(calendar.getWeekday(new Ng2vDate(1431, 1, 11))).toEqual(1);
    expect(calendar.getWeekday(new Ng2vDate(1431, 7, 22))).toEqual(7);
    expect(calendar.getWeekday(new Ng2vDate(1431, 2, 3))).toEqual(2);
    expect(calendar.getWeekday(new Ng2vDate(1431, 3, 10))).toEqual(3);
    expect(calendar.getWeekday(new Ng2vDate(1431, 4, 23))).toEqual(4);
    expect(calendar.getWeekday(new Ng2vDate(1202, 2, 19))).toEqual(5);
    expect(calendar.getWeekday(new Ng2vDate(1431, 7, 21))).toEqual(6);
  });
  it('should add days to date', () => {
    expect(calendar.getNext(new Ng2vDate(1431, 1, 30))).toEqual(new Ng2vDate(1431, 2, 1));
    expect(calendar.getNext(new Ng2vDate(1437, 2, 28))).toEqual(new Ng2vDate(1437, 2, 29));
    expect(calendar.getNext(new Ng2vDate(1437, 2, 29))).toEqual(new Ng2vDate(1437, 3, 1));
  });

  it('should subtract days from date', () => {
    expect(calendar.getPrev(new Ng2vDate(1431, 2, 1))).toEqual(new Ng2vDate(1431, 1, 30));
    expect(calendar.getPrev(new Ng2vDate(1431, 3, 1))).toEqual(new Ng2vDate(1431, 2, 29));
    expect(calendar.getPrev(new Ng2vDate(1437, 3, 5))).toEqual(new Ng2vDate(1437, 3, 4));
  });

  it('should add months to date', () => {
    expect(calendar.getNext(new Ng2vDate(1437, 8, 22), 'm')).toEqual(new Ng2vDate(1437, 9, 1));
    expect(calendar.getNext(new Ng2vDate(1437, 8, 1), 'm')).toEqual(new Ng2vDate(1437, 9, 1));
    expect(calendar.getNext(new Ng2vDate(1437, 12, 22), 'm')).toEqual(new Ng2vDate(1438, 1, 1));
  });

  it('should subtract months from date', () => {
    expect(calendar.getPrev(new Ng2vDate(1437, 8, 22), 'm')).toEqual(new Ng2vDate(1437, 7, 1));
    expect(calendar.getPrev(new Ng2vDate(1437, 9, 1), 'm')).toEqual(new Ng2vDate(1437, 8, 1));
    expect(calendar.getPrev(new Ng2vDate(1437, 1, 22), 'm')).toEqual(new Ng2vDate(1436, 12, 1));
  });

  it('should add years to date', () => {
    expect(calendar.getNext(new Ng2vDate(1437, 2, 22), 'y')).toEqual(new Ng2vDate(1438, 1, 1));
    expect(calendar.getNext(new Ng2vDate(1438, 12, 22), 'y')).toEqual(new Ng2vDate(1439, 1, 1));
  });

  it('should subtract years from date', () => {
    expect(calendar.getPrev(new Ng2vDate(1437, 12, 22), 'y')).toEqual(new Ng2vDate(1436, 1, 1));
    expect(calendar.getPrev(new Ng2vDate(1438, 2, 22), 'y')).toEqual(new Ng2vDate(1437, 1, 1));
  });

  it('should return week number', () => {
    let week = [
      new Ng2vDate(1437, 1, 4), new Ng2vDate(1437, 1, 5), new Ng2vDate(1437, 1, 6), new Ng2vDate(1437, 1, 7),
      new Ng2vDate(1437, 1, 8), new Ng2vDate(1437, 1, 9), new Ng2vDate(1437, 1, 10)
    ];
    expect(calendar.getWeekNumber(week, 7)).toEqual(2);
    week = [
      new Ng2vDate(1437, 12, 15), new Ng2vDate(1437, 12, 16), new Ng2vDate(1437, 12, 17), new Ng2vDate(1437, 12, 18),
      new Ng2vDate(1437, 12, 19), new Ng2vDate(1437, 12, 20), new Ng2vDate(1437, 12, 21)
    ];
    expect(calendar.getWeekNumber(week, 7)).toEqual(50);
    week = [
      new Ng2vDate(1437, 12, 22), new Ng2vDate(1437, 12, 23), new Ng2vDate(1437, 12, 24), new Ng2vDate(1437, 12, 25),
      new Ng2vDate(1437, 12, 26), new Ng2vDate(1437, 12, 27), new Ng2vDate(1437, 12, 28)
    ];
  ...
  describe('setDay', () => {
    it('should return correct value of day', () => {
      expect(calendar.setDay(new Ng2vDate(1202, 9, 1), 19).day).toEqual(19);
      expect(calendar.setDay(new Ng2vDate(1431, 1, 1), 1).day).toEqual(1);
      expect(calendar.setDay(new Ng2vDate(1431, 1, 1), 31).day).toEqual(1);
      expect(calendar.setDay(new Ng2vDate(1437, 1, 1), 61).day).toEqual(2);
      expect(calendar.setDay(new Ng2vDate(1431, 2, 1), 0).day).toEqual(30);
      expect(calendar.setDay(new Ng2vDate(1431, 2, 1), -1).day).toEqual(29);
      expect(calendar.setDay(new Ng2vDate(1431, 2, 1), -2).day).toEqual(28);
    });
  });

  describe('setMonth', () => {
    it('should return correct value of month', () => {
      expect(calendar.setMonth(new Ng2vDate(1202, 9, 1), 9).month).toEqual(9);
      expect(calendar.setMonth(new Ng2vDate(1431, 1, 30), 1).month).toEqual(1);
      expect(calendar.setDay(new Ng2vDate(1431, 1, 1), 31).month).toEqual(2);
      expect(calendar.setDay(new Ng2vDate(1437, 1, 1), 61).month).toEqual(3);
      expect(calendar.setDay(new Ng2vDate(1431, 2, 1), -1).month).toEqual(1);
      expect(calendar.setDay(new Ng2vDate(1431, 2, 1), -30).month).toEqual(12);
      expect(calendar.setMonth(new Ng2vDate(1431, 1, 1), 0).month).toEqual(12);
    });
  });

  describe('setYear', () => {
    it('should return correct value of yar', () => {
      expect(calendar.setYear(new Ng2vDate(1200, 1, 1), 1202).year).toEqual(1202);
      expect(calendar.setYear(new Ng2vDate(1430, 11, 30), 1431).year).toEqual(1431);
      expect(calendar.setDay(new Ng2vDate(1431, 12, 1), 31).year).toEqual(1432);
      expect(calendar.setMonth(new Ng2vDate(1431, 1, 1), 13).year).toEqual(1432);
      expect(calendar.setMonth(new Ng2vDate(1431, 1, 1), 25).year).toEqual(1433);
      expect(calendar.setDay(new Ng2vDate(1431, 1, 1), -1).year).toEqual(1430);
      expect(calendar.setMonth(new Ng2vDate(1431, 1, 1), 0).year).toEqual(1430);
      expect(calendar.setMonth(new Ng2vDate(1431, 1, 1), -13).year).toEqual(1429);
    });
  });
});
