import {Ng2vDateISOParserFormatter} from './ng2v-date-parser-formatter';

describe('ng2v-date parsing and formatting', () => {
  let pf: Ng2vDateISOParserFormatter;

  beforeEach(() => { pf = new Ng2vDateISOParserFormatter(); });
