...
const NG2V_TABSET_DIRECTIVES = [Ng2vTabset, Ng2vTab, Ng2vTabContent, Ng2vTabTitle];

@NgModule({declarations: NG2V_TABSET_DIRECTIVES, exports: NG2V_TABSET_DIRECTIVES, imports: [CommonModule]})
