...
import {Ng2vTimepickerModule} from './timepicker.module';
...
function getTimepicker(el: HTMLElement) {
  return el.querySelector('ng2v-timepicker');
}
...
function expectSameValues(timepicker: Ng2vTimepicker, config: Ng2vTimepickerConfig) {
...
function customizeConfig(config: Ng2vTimepickerConfig) {
...
describe('ng2v-timepicker', () => {

  beforeEach(() => {
    TestBed.configureTestingModule(
        {declarations: [TestComponent], imports: [Ng2vTimepickerModule.forRoot(), FormsModule, ReactiveFormsModule]});
  });

  describe('initialization', () => {
    it('should initialize inputs with provided config', () => {
      const defaultConfig = new Ng2vTimepickerConfig();
      const timepicker = new Ng2vTimepicker(new Ng2vTimepickerConfig());
  ...
  describe('rendering based on model', () => {
    ...
    it('should render hour and minute inputs', async(() => {
         const html = `<ng2v-timepicker [ngModel]="model"></ng2v-timepicker>`;
    ...
    it('should render hour, minute and seconds inputs with padding', async(() => {
         const html = `<ng2v-timepicker [ngModel]="model" [seconds]="true"></ng2v-timepicker>`;
  ...
  describe('meridian', () => {
    ...
    it('should render meridian button with proper value', async(() => {
         const html = `<ng2v-timepicker [(ngModel)]="model" [seconds]="true" [meridian]="true"></ng2v-timepicker>`;
  ...
  describe('forms', () => {
    ...
    it('should work with template-driven form validation', async(() => {
         const html = `
          <form>
            <ng2v-timepicker [(ngModel)]="model" name="control" required></ng2v-timepicker>
          </form>`;
    ...
    it('should work with model-driven form validation', async(() => {
         const html = `
          <form [formGroup]="form">
            <ng2v-timepicker formControlName="control" required></ng2v-timepicker>
          </form>`;
    ...
    it('should not submit form when spinners clicked', async(() => {
         const html = `<form (ngSubmit)="onSubmit()">
           <ng2v-timepicker name="control" [(ngModel)]="model"></ng2v-timepicker>
           </form>`;
  ...
  describe('disabled', () => {
    ...
    it('should not change the value on button click, when it is disabled', async(() => {
         const html = `<ng2v-timepicker [(ngModel)]="model" [seconds]="true" [disabled]="disabled"></ng2v-timepicker>`;
    ...
    it('should have disabled attribute when it is disabled using reactive forms', async(() => {
         const html = `<form [formGroup]="disabledForm"><ng2v-timepicker formControlName="control"></ng2v-timepicker></form>`;
  ...
  describe('readonly', () => {
    ...
    it('should change the value on button click, when it is readonly', async(() => {
         const html =
             `<ng2v-timepicker [(ngModel)]="model" [seconds]="true" [readonlyInputs]="readonly"></ng2v-timepicker>`;
    ...
    it('should not change value on input change, when it is readonly', () => {
      const html = `<ng2v-timepicker [(ngModel)]="model" [seconds]="true" [readonlyInputs]="readonly"></ng2v-timepicker>`;
  ...
  describe('spinners', () => {
    ...
    it('should not have spinners if configured so', () => {
      const html = `<ng2v-timepicker [(ngModel)]="model" [seconds]="true" [spinners]="false"></ng2v-timepicker>`;
  ...
  describe('size', () => {
    ...
    it('should add appropriate CSS classes to butons and inputs when size is small', () => {
      const html = `<ng2v-timepicker size="small"></ng2v-timepicker>`;
    ...
    it('should add appropriate CSS classes to butons and inputs when size is large', () => {
      const html = `<ng2v-timepicker size="large"></ng2v-timepicker>`;
    ...
    it('should not add special CSS classes to butons and inputs when size is medium', () => {
      const html = `<ng2v-timepicker size="medium"></ng2v-timepicker>`;
    ...
    it('should not add special CSS classes to butons and inputs when no size is specified', () => {
      const html = `<ng2v-timepicker></ng2v-timepicker>`;
  ...
  describe('Custom config', () => {
    let config: Ng2vTimepickerConfig;

    beforeEach(() => {
      TestBed.configureTestingModule({imports: [Ng2vTimepickerModule.forRoot()]});
      TestBed.overrideComponent(Ng2vTimepicker, {set: {template: ''}});
    });

    beforeEach(inject([Ng2vTimepickerConfig], (c: Ng2vTimepickerConfig) => {
      config = c;
      customizeConfig(config);
    }));

    it('should initialize inputs with provided config', () => {
      const fixture = TestBed.createComponent(Ng2vTimepicker);
  ...
  describe('Custom config as provider', () => {
    const config = new Ng2vTimepickerConfig();
    customizeConfig(config);

    beforeEach(() => {
      TestBed.configureTestingModule(
          {imports: [Ng2vTimepickerModule.forRoot()], providers: [{provide: Ng2vTimepickerConfig, useValue: config}]});
    });

    it('should initialize inputs with provided config as provider', () => {
      const fixture = createGenericTestComponent('', Ng2vTimepicker);
  ...
  describe('Seconds handling', () => {
    it('should propagate seconds to 0 in model if seconds not shown and no second in initial model', async(() => {
         const html = `<ng2v-timepicker [(ngModel)]="model" [seconds]="false"></ng2v-timepicker>`;
    ...
    it('should reset the second to 0 if invalid when seconds are hidden', async(() => {
         const html = `<ng2v-timepicker [(ngModel)]="model" [seconds]="showSeconds"></ng2v-timepicker>`;
