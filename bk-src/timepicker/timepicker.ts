...
const NGB_TIMEPICKER_VALUE_ACCESSOR = {
  ...
  useExisting: forwardRef(() => Ng2vTimepicker),
  multi: true
};
...
@Component({
  ...
  styles: [`
    ...
    .ng2v-tp-hour, .ng2v-tp-minute, .ng2v-tp-second, .ng2v-tp-meridian {
      display: flex;
  ...
  template: `
    <fieldset [disabled]="disabled" [class.disabled]="disabled">
      <div class="ng2v-tp">
        ...
        <div class="ng2v-tp-spacer">:</div>
        <div class="ng2v-tp-minute">
        ...
        <div *ngIf="seconds" class="ng2v-tp-spacer">:</div>
        <div *ngIf="seconds" class="ng2v-tp-second">
        ...
        <div *ngIf="meridian" class="ng2v-tp-spacer"></div>
        <div *ngIf="meridian" class="ng2v-tp-meridian">
...
export class Ng2vTimepicker implements ControlValueAccessor,
    OnChanges {
  disabled: boolean;
  model: Ng2vTime;
  ...
  writeValue(value) {
    this.model = value ? new Ng2vTime(value.hour, value.minute, value.second) : new Ng2vTime();
