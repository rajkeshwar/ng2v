import {Ng2vTime} from './ng2v-time';

describe('Ng2vTime', () => {

  it('should allow constructing new objects', () => {
    expect(new Ng2vTime(undefined, undefined).toString()).toBe('0:0:0');
    expect(new Ng2vTime(12, 31, 45).toString()).toBe('12:31:45');
  });

  it('should allow changing hours', () => {
    const t = new Ng2vTime(10, 30);
  ...
  it('should properly change undefined hours', () => {
    const t = new Ng2vTime(undefined, 30);
  ...
  it('should properly change undefined minutes', () => {
    const t = new Ng2vTime(1, undefined);
  ...
  it('should properly change undefined minutes', () => {
    const t = new Ng2vTime(1, 20, undefined);
  ...
  it('should have a validity flag', () => {
    expect(new Ng2vTime(11, 0, 30).isValid()).toBeTruthy();
    expect(new Ng2vTime(null, 0, 30).isValid()).toBeFalsy();
    expect(new Ng2vTime(11, null, 30).isValid()).toBeFalsy();
    expect(new Ng2vTime(11, 0, null).isValid()).toBeFalsy();
    expect(new Ng2vTime(null, 0, null).isValid()).toBeFalsy();
    expect(new Ng2vTime(null, null, null).isValid()).toBeFalsy();
  });

  it('should have a validity flag with optional seconds checking',
     () => { expect(new Ng2vTime(11, 0).isValid(false)).toBeTruthy(); });
});
