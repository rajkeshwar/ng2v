...
/**
 * Type of the service supplying month and weekday names to to Ng2vDatepicker component.
 * See the i18n demo for how to extend this class and define a custom provider for i18n.
 */
@Injectable()
export abstract class Ng2vDatepickerI18n {
  /**
...
@Injectable()
export class Ng2vDatepickerI18nDefault extends Ng2vDatepickerI18n {
