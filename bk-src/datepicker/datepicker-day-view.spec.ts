...
function getElement(element: HTMLElement): HTMLElement {
  return <HTMLElement>element.querySelector('[ng2vDatepickerDayView]');
}

describe('ng2vDatepickerDayView', () => {

  beforeEach(() => {
    TestBed.overrideModule(Ng2vDatepickerModule, {set: {exports: [Ng2vDatepickerDayView]}});
...
class TestComponent {
  currentMonth = 7;
  date: Ng2vDateStruct = {year: 2016, month: 7, day: 22};
  disabled = false;
  selected = false;
}
