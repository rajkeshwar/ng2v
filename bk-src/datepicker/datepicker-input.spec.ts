...
describe('Ng2vInputDatepicker', () => {

  beforeEach(() => {
    TestBed.configureTestingModule(
        {declarations: [TestComponent], imports: [Ng2vDatepickerModule.forRoot(), FormsModule]});
  });
  ...
  describe('open, close and toggle', () => {
    ...
    it('should allow controlling datepicker popup from outside', () => {
      const fixture = createTestCmpt(`
          <input ng2vDatepicker #d="ng2vDatepicker">
      ...
      expect(fixture.nativeElement.querySelector('ng2v-datepicker')).not.toBeNull();

      buttons[1].click();  // close
      fixture.detectChanges();
      expect(fixture.nativeElement.querySelector('ng2v-datepicker')).toBeNull();
  ...
  describe('ngModel interactions', () => {
    ...
    it('should format bound date as ISO (by default) in the input field', fakeAsync(() => {
         const fixture = createTestCmpt(`<input ng2vDatepicker [ngModel]="date">`);
    ...
    it('should set only valid dates', fakeAsync(() => {
         ...
         fixture.componentInstance.date = new Ng2vDate(300000, 1, 1);
         fixture.detectChanges();
         tick();
         expect(input.value).toBe('');

         fixture.componentInstance.date = new Ng2vDate(2017, 2, null);
         fixture.detectChanges();
         tick();
         expect(input.value).toBe('');

         fixture.componentInstance.date = new Ng2vDate(2017, null, 5);
         fixture.detectChanges();
         tick();
         expect(input.value).toBe('');

         fixture.componentInstance.date = new Ng2vDate(null, 2, 5);
         fixture.detectChanges();
         tick();
         expect(input.value).toBe('');

         fixture.componentInstance.date = new Ng2vDate(<any>'2017', <any>'03', <any>'10');
         fixture.detectChanges();
         tick();
         expect(input.value).toBe('');
       }));
    ...
    it('should propagate disabled state', fakeAsync(() => {
         const fixture = createTestCmpt(`
        <input ng2vDatepicker [(ngModel)]="date" #d="ng2vDatepicker" [disabled]="isDisabled">
        <button (click)="open(d)">Open</button>`);
         ...
         tick();
         fixture.detectChanges();
         const buttonInDatePicker = fixture.nativeElement.querySelector('ng2v-datepicker button');
    ...
    it('should propagate touched state when setting a date', fakeAsync(() => {
         const fixture = createTestCmpt(`
      <input ng2vDatepicker [(ngModel)]="date" #d="ng2vDatepicker">
      <button (click)="open(d)">Open</button>`);
  ...
  describe('validation', () => {
    ...
    describe('values set from model', () => {
      ...
      it('should not return errors for valid model', fakeAsync(() => {
           const fixture = createTestCmpt(
               `<form><input ng2vDatepicker [ngModel]="{year: 2017, month: 04, day: 04}" name="dp"></form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);

           fixture.detectChanges();
           tick();
           expect(form.control.valid).toBeTruthy();
           expect(form.control.hasError('ng2vDate', ['dp'])).toBeFalsy();
         }));

      it('should not return errors for empty model', fakeAsync(() => {
           const fixture = createTestCmpt(`<form><input ng2vDatepicker [ngModel]="date" name="dp"></form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);
      ...
      it('should return "invalid" errors for invalid model', fakeAsync(() => {
           const fixture = createTestCmpt(`<form><input ng2vDatepicker [ngModel]="5" name="dp"></form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);

           fixture.detectChanges();
           tick();
           expect(form.control.invalid).toBeTruthy();
           expect(form.control.getError('ng2vDate', ['dp']).invalid).toBe(5);
         }));

      it('should return "requiredBefore" errors for dates before minimal date', fakeAsync(() => {
           const fixture = createTestCmpt(`<form>
          <input ng2vDatepicker [ngModel]="{year: 2017, month: 04, day: 04}" [minDate]="{year: 2017, month: 6, day: 4}" name="dp">
        </form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);
      ...
      it('should return "requiredAfter" errors for dates after maximal date', fakeAsync(() => {
           const fixture = createTestCmpt(`<form>
          <input ng2vDatepicker [ngModel]="{year: 2017, month: 04, day: 04}" [maxDate]="{year: 2017, month: 2, day: 4}" name="dp">
        </form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);
      ...
      it('should update validity status when minDate changes', fakeAsync(() => {
           const fixture = createTestCmpt(`<form>
          <input ng2vDatepicker [ngModel]="{year: 2017, month: 2, day: 4}" [minDate]="date" name="dp">
        </form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);
      ...
      it('should update validity status when maxDate changes', fakeAsync(() => {
           const fixture = createTestCmpt(`<form>
          <input ng2vDatepicker [ngModel]="{year: 2017, month: 2, day: 4}" [maxDate]="date" name="dp">
        </form>`);
           const form = fixture.debugElement.query(By.directive(NgForm)).injector.get(NgForm);
  ...
  describe('options', () => {
    ...
    it('should propagate the "dayTemplate" option', () => {
      const fixture = createTestCmpt(`<ng-template #t></ng-template><input ng2vDatepicker [dayTemplate]="t">`);
      const dpInput = fixture.debugElement.query(By.directive(Ng2vInputDatepicker)).injector.get(Ng2vInputDatepicker);

      dpInput.open();
      fixture.detectChanges();

      const dp = fixture.debugElement.query(By.css('ng2v-datepicker')).injector.get(Ng2vDatepicker);
      expect(dp.dayTemplate).toBeDefined();
    });

    it('should propagate the "displayMonths" option', () => {
      const fixture = createTestCmpt(`<input ng2vDatepicker [displayMonths]="3">`);
      const dpInput = fixture.debugElement.query(By.directive(Ng2vInputDatepicker)).injector.get(Ng2vInputDatepicker);
    ...
    it('should propagate the "firstDayOfWeek" option', () => {
      const fixture = createTestCmpt(`<input ng2vDatepicker [firstDayOfWeek]="5">`);
      const dpInput = fixture.debugElement.query(By.directive(Ng2vInputDatepicker)).injector.get(Ng2vInputDatepicker);
    ...
    it('should propagate the "markDisabled" option', () => {
      const fixture = createTestCmpt(`<input ng2vDatepicker [markDisabled]="noop">`);
      const dpInput = fixture.debugElement.query(By.directive(Ng2vInputDatepicker)).injector.get(Ng2vInputDatepicker);
    ...
    it('should propagate the "minDate" option', () => {
      const fixture = createTestCmpt(`<input ng2vDatepicker [minDate]="{year: 2016, month: 9, day: 13}">`);
      const dpInput = fixture.debugElement.query(By.directive(Ng2vInputDatepicker)).injector.get(Ng2vInputDatepicker);
    ...
    it('should propagate the "maxDate" option', () => {
      const fixture = createTestCmpt(`<input ng2vDatepicker [maxDate]="{year: 2016, month: 9, day: 13}">`);
      const dpInput = fixture.debugElement.query(By.directive(Ng2vInputDatepicker)).injector.get(Ng2vInputDatepicker);
    ...
    it('should propagate the "outsideDays" option', () => {
      const fixture = createTestCmpt(`<input ng2vDatepicker outsideDays="collapsed">`);
      const dpInput = fixture.debugElement.query(By.directive(Ng2vInputDatepicker)).injector.get(Ng2vInputDatepicker);
    ...
    it('should propagate the "navigation" option', () => {
      const fixture = createTestCmpt(`<input ng2vDatepicker navigation="none">`);
      const dpInput = fixture.debugElement.query(By.directive(Ng2vInputDatepicker)).injector.get(Ng2vInputDatepicker);
    ...
    it('should propagate the "showWeekdays" option', () => {
      const fixture = createTestCmpt(`<input ng2vDatepicker [showWeekdays]="true">`);
      const dpInput = fixture.debugElement.query(By.directive(Ng2vInputDatepicker)).injector.get(Ng2vInputDatepicker);
    ...
    it('should propagate the "showWeekNumbers" option', () => {
      const fixture = createTestCmpt(`<input ng2vDatepicker [showWeekNumbers]="true">`);
      const dpInput = fixture.debugElement.query(By.directive(Ng2vInputDatepicker)).injector.get(Ng2vInputDatepicker);
    ...
    it('should propagate the "startDate" option', () => {
      const fixture = createTestCmpt(`<input ng2vDatepicker [startDate]="{year: 2016, month: 9, day: 13}">`);
      const dpInput = fixture.debugElement.query(By.directive(Ng2vInputDatepicker)).injector.get(Ng2vInputDatepicker);
    ...
    it('should propagate model as "startDate" option when "startDate" not provided', fakeAsync(() => {
         const fixture = createTestCmpt(`<input ng2vDatepicker [ngModel]="{year: 2016, month: 9, day: 13}">`);
         const dpInput = fixture.debugElement.query(By.directive(Ng2vInputDatepicker)).injector.get(Ng2vInputDatepicker);
         ...
         const dp = fixture.debugElement.query(By.css('ng2v-datepicker')).injector.get(Ng2vDatepicker);
         expect(dp.startDate).toEqual(Ng2vDate.from({year: 2016, month: 9, day: 13}));
       }));

    it('should relay the "navigate" event', () => {
      const fixture =
          createTestCmpt(`<input ng2vDatepicker [startDate]="{year: 2016, month: 9}" (navigate)="onNavigate($event)">`);
      const dpInput = fixture.debugElement.query(By.directive(Ng2vInputDatepicker)).injector.get(Ng2vInputDatepicker);
...
class TestComponent {
  ...
  open(d: Ng2vInputDatepicker) { d.open(); }

  close(d: Ng2vInputDatepicker) { d.close(); }

  toggle(d: Ng2vInputDatepicker) { d.toggle(); }
