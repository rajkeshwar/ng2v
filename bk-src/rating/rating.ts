...
const NGB_RATING_VALUE_ACCESSOR = {
  ...
  useExisting: forwardRef(() => Ng2vRating),
  multi: true
};
...
export class Ng2vRating implements ControlValueAccessor,
    OnInit, OnChanges {
  ...
  constructor(config: Ng2vRatingConfig, private _changeDetectorRef: ChangeDetectorRef) {
    this.max = config.max;
