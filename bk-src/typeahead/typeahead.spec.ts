...
import {Ng2vTypeahead} from './typeahead';
...
function getWindow(element): HTMLDivElement {
  return <HTMLDivElement>element.querySelector('ng2v-typeahead-window.dropdown-menu');
}

function getDebugInput(element: DebugElement): DebugElement {
  return element.query(By.directive(Ng2vTypeahead));
}
...
describe('ng2v-typeahead', () => {

  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [TestComponent, TestOnPushComponent],
      imports: [Ng2vTypeaheadModule.forRoot(), FormsModule, ReactiveFormsModule]
    });
  });
  ...
  describe('valueaccessor', () => {
    ...
    it('should format values when no formatter provided', async(() => {
         const fixture = createTestComponent('<input [(ngModel)]="model" [ng2vTypeahead]="findNothing" />');
    ...
    it('should format values with custom formatter provided', async(() => {
         const html =
             '<input [(ngModel)]="model" [ng2vTypeahead]="findNothing" [inputFormatter]="uppercaseObjFormatter"/>';
  ...
  describe('window', () => {
    ...
    it('should be closed by default', () => {
      const fixture = createTestComponent(`<input type="text" [ng2vTypeahead]="find"/>`);
      const compiled = fixture.nativeElement;
      expect(getWindow(compiled)).toBeNull();
    });

    it('should not be opened when the model changes', async(() => {
         const fixture = createTestComponent(`<input type="text" [(ngModel)]="model" [ng2vTypeahead]="find"/>`);
         const compiled = fixture.nativeElement;
    ...
    it('should be closed when there no results', () => {
      const fixture = createTestComponent(`<input type="text" [ng2vTypeahead]="findNothing"/>`);
      const compiled = fixture.nativeElement;
    ...
    it('should use provided result formatter function', () => {
      const fixture =
          createTestComponent(`<input type="text" [ng2vTypeahead]="find" [resultFormatter]="uppercaseFormatter"/>`);
      const compiled = fixture.nativeElement;
    ...
    it('should not mark first result as active when focusFirst is false', () => {
      const fixture = createTestComponent(`<input type="text" [ng2vTypeahead]="find" [focusFirst]="false"/>`);
      const compiled = fixture.nativeElement;
    ...
    it('should not select the result on TAB, close window and not write to the input when focusFirst is false', () => {
      const fixture =
          createTestComponent(`<input type="text" [(ngModel)]="model" [ng2vTypeahead]="find" [focusFirst]="false"/>`);
      const compiled = fixture.nativeElement;
    ...
    it('should properly display results when an owning components using OnPush strategy', fakeAsync(() => {
         const fixture = createOnPushTestComponent(`<input type="text" [(ngModel)]="model" [ng2vTypeahead]="find"/>`);
         const compiled = fixture.nativeElement;
  ...
  describe('objects', () => {
    ...
    it('should work with custom objects as values', async(() => {
         const fixture = createTestComponent(`
             <input type="text" [(ngModel)]="model" [ng2vTypeahead]="findObjects"
  ...
  describe('forms', () => {
    ...
    it('should work with template-driven form validation', async(() => {
         const html = `
            <form>
              <input type="text" [(ngModel)]="model" name="control" required [ng2vTypeahead]="findObjects" />
            </form>`;
         const fixture = createTestComponent(html);
         fixture.whenStable().then(() => {
           fixture.detectChanges();
    ...
    it('should work with model-driven form validation', () => {
      const html = `
           <form [formGroup]="form">
             <input type="text" formControlName="control" required [ng2vTypeahead]="findObjects" />
           </form>`;
      const fixture = createTestComponent(html);
      const compiled = fixture.nativeElement;
    ...
    it('should support disabled state', async(() => {
         const html = `
            <form>
              <input type="text" [(ngModel)]="model" name="control" [disabled]="true" [ng2vTypeahead]="findObjects" />
            </form>`;
         const fixture = createTestComponent(html);
         fixture.whenStable().then(() => {
           fixture.detectChanges();
    ...
    it('should only propagate model changes on select when the editable option is on', async(() => {
         const html = `
            <form>
              <input type="text" [(ngModel)]="model" name="control" required [ng2vTypeahead]="find" [editable]="false"/>
            </form>`;
         const fixture = createTestComponent(html);
         fixture.whenStable().then(() => {
           fixture.detectChanges();
  ...
  describe('select event', () => {
    ...
    it('should raise select event when a result is selected', () => {
      const fixture = createTestComponent('<input [ng2vTypeahead]="find" (selectItem)="onSelect($event.item)"/>');
    ...
    it('should not propagate model when preventDefault() is called on selectEvent', async(() => {
         const fixture = createTestComponent(
             '<input [(ngModel)]="model" [ng2vTypeahead]="find" (selectItem)="$event.preventDefault()"/>');
         const input = getNativeInput(fixture.nativeElement);
  ...
  describe('auto attributes', () => {
    ...
    it('should have autocomplete, autocapitalize and autocorrect attributes set to off', () => {
      const fixture = createTestComponent('<input type="text" [ng2vTypeahead]="findObjects" />');
      const input = getNativeInput(fixture.nativeElement);
  ...
  describe('accessibility', () => {
    ...
    it('should correctly set aria-autocomplete depending on showHint', () => {
      const fixture = createTestComponent('<input type="text" [ng2vTypeahead]="findObjects"  [showHint]="true" />');
      const input = getNativeInput(fixture.nativeElement);
    ...
    it('should have the correct ARIA attributes when interacting with input', async(() => {
         ...
         fixture.whenStable().then(() => {
           ...
           expect(input.getAttribute('aria-owns')).toMatch(/ng2v-typeahead-[0-9]+/);
           expect(input.getAttribute('aria-activedescendant')).toMatch(/ng2v-typeahead-[0-9]+-0/);

           let event = createKeyDownEvent(Key.ArrowDown);
           getDebugInput(fixture.debugElement).triggerEventHandler('keydown', event);
           fixture.detectChanges();
           expect(input.getAttribute('aria-activedescendant')).toMatch(/ng2v-typeahead-[0-9]+-1/);
  ...
  if (!isBrowser(['ie', 'edge'])) {
    describe('hint', () => {
      ...
      it('should show hint when an item starts with user input', async(() => {
           const fixture = createTestComponent(
               `<input type="text" [(ngModel)]="model" [ng2vTypeahead]="findAnywhere" [showHint]="true"/>`);
           const compiled = fixture.nativeElement;
    ...
    describe('Custom config', () => {
      beforeEach(() => {
        TestBed.overrideComponent(
            TestComponent, {set: {template: '<input type="text" [(ngModel)]="model" [ng2vTypeahead]="findAnywhere"/>'}});
      });

      beforeEach(inject([Ng2vTypeaheadConfig], (c: Ng2vTypeaheadConfig) => { c.showHint = true; }));
    ...
    describe('Custom config as provider', () => {
      beforeEach(() => {
        ...
        TestBed.configureTestingModule({providers: [{provide: Ng2vTypeaheadConfig, useValue: config}]});
...
class TestComponent {
  ...
  @ViewChild(Ng2vTypeahead) typeahead: Ng2vTypeahead;
