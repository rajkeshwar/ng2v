...
const NGB_RADIO_VALUE_ACCESSOR = {
  ...
  useExisting: forwardRef(() => Ng2vRadioGroup),
  multi: true
};
...
export class Ng2vRadioGroup implements ControlValueAccessor {
  private _radios: Set<Ng2vRadio> = new Set<Ng2vRadio>();
  private _value = null;
  ...
  register(radio: Ng2vRadio) { this._radios.add(radio); }
  ...
  unregister(radio: Ng2vRadio) { this._radios.delete(radio); }
...
/**
 * Marks an input of type "radio" as part of the Ng2vRadioGroup.
 */
@Directive({
...
export class Ng2vRadio implements OnDestroy {
  ...
  */
  ...
  constructor(
      @Optional() private _group: Ng2vRadioGroup, @Optional() private _label: Ng2vActiveLabel,
