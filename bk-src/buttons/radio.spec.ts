...
import {Ng2vButtonsModule} from './radio.module';
...
function getGroupElement(nativeEl: HTMLElement): HTMLDivElement {
  return <HTMLDivElement>nativeEl.querySelector('div[ng2vRadioGroup]');
}
...
describe('Ng2vActiveLabel', () => {
  beforeEach(() => {
    TestBed.configureTestingModule(
        {declarations: [TestComponent], imports: [Ng2vButtonsModule, FormsModule, ReactiveFormsModule]});
  });
...
describe('ng2vRadioGroup', () => {
  const defaultHtml = `<div [(ngModel)]="model" ng2vRadioGroup>
      <label class="btn">
  ...
  it('can be used with ngFor', async(() => {
       ...
       const forHtml = `<div [(ngModel)]="model" ng2vRadioGroup>
  ...
  it('cleans up the model when radio inputs are added / removed', async(() => {
       ...
       const ifHtml = `<div [(ngModel)]="model" ng2vRadioGroup>
        <label class="btn">
          <input type="radio" name="radio" [value]="values[0]"/> {{ values[0] }}
        </label>
  ...
  it('should add data-toggle="buttons" and "btn-group" CSS class to button group', () => {
    ...
    const html = `<div class="foo" ng2vRadioGroup></div>`;
  ...
  it('should work with template-driven form validation', async(() => {
       const html = `
        <form>
          <div ng2vRadioGroup [(ngModel)]="model" name="control" required>
            <label class="btn">
  ...
  it('should work with model-driven form validation', () => {
    const html = `
        <form [formGroup]="form">
          <div ng2vRadioGroup formControlName="control">
            <label class="btn">
              <input type="radio" value="foo"/>
            </label>          
          </div>
  ...
  it('should disable label and input when it is disabled using template-driven forms', async(() => {
       const html = `
      <form>
        <div ng2vRadioGroup [(ngModel)]="model" name="control" [disabled]="disabled">
          <label class="btn">
            <input type="radio" value="foo"/>
          </label>          
        </div>
  ...
  it('should disable individual label and input using template-driven forms', async(() => {
       const html = `
      <form>
        <div ng2vRadioGroup [(ngModel)]="model" name="control">
          <label class="btn">
  ...
  it('disable all radio buttons when group is disabled regardless of button disabled state', async(() => {
       const html = `
      <form>
        <div ng2vRadioGroup [(ngModel)]="model" name="control" [disabled]="groupDisabled">
          <label class="btn">
            <input type="radio" value="foo" [disabled]="disabled"/>
          </label>          
        </div>
  ...
  it('should add / remove "focus" class on labels', () => {
    const fixture = createTestComponent(`
      <div [(ngModel)]="model" ng2vRadioGroup>
        <label class="btn">
          <input type="radio" name="radio" [value]="values[0]"/> {{ values[0] }}
        </label>
        <label class="btn">
