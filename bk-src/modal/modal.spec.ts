...
import {Ng2vModalModule, Ng2vModal, Ng2vActiveModal, Ng2vModalRef} from './modal.module';
...
describe('ng2v-modal', () => {
      ...
      toHaveModal: function(util, customEqualityTests) {
        return {
          ...
          negativeCompare: function(actual) {
            const allOpenModals = actual.querySelectorAll('ng2v-modal-window');
      ...
      toHaveBackdrop: function(util, customEqualityTests) {
        return {
          compare: function(actual) {
            return {
              pass: document.querySelectorAll('ng2v-modal-backdrop').length === 1,
              message: `Expected ${actual.outerHTML} to have exactly one backdrop element`
            };
          },
          negativeCompare: function(actual) {
            const allOpenModals = document.querySelectorAll('ng2v-modal-backdrop');
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({imports: [Ng2vModalTestModule]});
  ...
  afterEach(() => {
    ...
    const remainingModalWindows = document.querySelectorAll('ng2v-modal-window');
    if (remainingModalWindows.length) {
      fail(`${remainingModalWindows.length} modal windows were left in the DOM.`);
    }

    const remainingModalBackdrops = document.querySelectorAll('ng2v-modal-backdrop');
  ...
  describe('backdrop options', () => {
    ...
    it('should dismiss on backdrop click', () => {
      ...
      (<HTMLElement>document.querySelector('ng2v-modal-window')).click();
      fixture.detectChanges();
  ...
  describe('keyboard options', () => {
    ...
    it('should dismiss modals on ESC by default', () => {
      ...
      (<DebugElement>getDebugNode(document.querySelector('ng2v-modal-window'))).triggerEventHandler('keyup.esc', {});
      fixture.detectChanges();
      expect(fixture.nativeElement).not.toHaveModal();
    });
  ...
  describe('custom class options', () => {
    ...
    it('should render modals with the correct custom classes', () => {
      ...
      fixture.detectChanges();
      expect(fixture.nativeElement).toHaveModal('foo');
      expect(document.querySelector('ng2v-modal-window')).toHaveCssClass('bar');
  ...
  describe('focus management', () => {
    ...
    it('should focus modal window and return focus to previously focused element', () => {
      ...
      expect(document.activeElement).toBe(document.querySelector('ng2v-modal-window'));
  ...
  describe('window element ordering', () => {
    it('should place newer windows on top of older ones', () => {
      ...
      let windows = document.querySelectorAll('ng2v-modal-window');
...
@NgModule({
  ...
  imports: [CommonModule, Ng2vModalModule.forRoot()],
  entryComponents: [DestroyableCmpt, WithActiveModalCmpt],
  providers: [SpyService]
})
class Ng2vModalTestModule {
}
