...
describe('ng2v-modal-dialog', () => {

  let fixture: ComponentFixture<Ng2vModalWindow>;

  beforeEach(() => {
    TestBed.configureTestingModule({declarations: [Ng2vModalWindow]});
    fixture = TestBed.createComponent(Ng2vModalWindow);
  });
