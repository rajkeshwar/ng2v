...
import {Ng2vPaginationModule} from './pagination.module';
...
function expectSameValues(pagination: Ng2vPagination, config: Ng2vPaginationConfig) {
...
describe('ng2v-pagination', () => {
  describe('business logic', () => {

    let pagination: Ng2vPagination;

    beforeEach(() => { pagination = new Ng2vPagination(new Ng2vPaginationConfig()); });

    it('should initialize inputs with default values', () => {
      const defaultConfig = new Ng2vPaginationConfig();
  ...
  describe('UI logic', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({declarations: [TestComponent], imports: [Ng2vPaginationModule.forRoot()]});
    });

    it('should render and respond to collectionSize change', () => {
      const html = '<ng2v-pagination [collectionSize]="collectionSize" [page]="1"></ng2v-pagination>';
    ...
    it('should render and respond to pageSize change', () => {
      const html =
          '<ng2v-pagination [collectionSize]="collectionSize" [page]="1" [pageSize]="pageSize"></ng2v-pagination>';
      const fixture = createTestComponent(html);
    ...
    it('should render and respond to active page change', () => {
      const html = '<ng2v-pagination [collectionSize]="collectionSize" [page]="page"></ng2v-pagination>';
      const fixture = createTestComponent(html);
    ...
    it('should update selected page model on prev / next click', () => {
      const html =
          '<ng2v-pagination [collectionSize]="collectionSize" [page]="page" [directionLinks]="directionLinks"></ng2v-pagination>';
      const fixture = createTestComponent(html);
    ...
    it('should update selected page model on first / last click', () => {
      const html = `<ng2v-pagination [collectionSize]="collectionSize" [page]="page" [maxSize]="maxSize"
              [boundaryLinks]="boundaryLinks"></ng2v-pagination>`;
      const fixture = createTestComponent(html);
    ...
    it('should update page when it becomes out of range', fakeAsync(() => {
         const html =
             '<ng2v-pagination [collectionSize]="collectionSize" [(page)]="page" [size]="size"></ng2v-pagination>';
         const fixture = createTestComponent(html);
    ...
    it('should render and respond to size change', () => {
      const html = '<ng2v-pagination [collectionSize]="20" [page]="1" [size]="size"></ng2v-pagination>';
    ...
    it('should render and respond to maxSize change correctly', () => {
      const html =
          '<ng2v-pagination [collectionSize]="70" [page]="page" [maxSize]="maxSize" [ellipses]="ellipses"></ng2v-pagination>';
      const fixture = createTestComponent(html);
    ...
    it('should render and rotate pages correctly', () => {
      const html = `<ng2v-pagination [collectionSize]="70" [page]="page" [maxSize]="maxSize" [rotate]="rotate"
        [ellipses]="ellipses"></ng2v-pagination>`;
      const fixture = createTestComponent(html);
    ...
    it('should display ellipsis correctly', () => {
      const html = `<ng2v-pagination [collectionSize]="70" [page]="page"
        [maxSize]="maxSize" [rotate]="rotate" [ellipses]="ellipses"></ng2v-pagination>`;
      const fixture = createTestComponent(html);
    ...
    it('should handle edge "maxSize" values', () => {
      const html = '<ng2v-pagination [collectionSize]="50" [maxSize]="maxSize"></ng2v-pagination>';
      const fixture = createTestComponent(html);
    ...
    it('should handle edge "collectionSize" values', () => {
      const html = '<ng2v-pagination [collectionSize]="collectionSize"></ng2v-pagination>';
      const fixture = createTestComponent(html);
    ...
    it('should handle edge "pageSize" values', () => {
      const html = '<ng2v-pagination [collectionSize]="50" [pageSize]="pageSize"></ng2v-pagination>';
      const fixture = createTestComponent(html);
    ...
    it('should handle edge "page" values', () => {
      const html = '<ng2v-pagination [collectionSize]="20" [page]="page"></ng2v-pagination>';
      const fixture = createTestComponent(html);
    ...
    it('should not emit "pageChange" for incorrect input values', fakeAsync(() => {
         const html = `<ng2v-pagination [collectionSize]="collectionSize" [pageSize]="pageSize" [maxSize]="maxSize"
        (pageChange)="onPageChange($event)"></ng2v-pagination>`;
         const fixture = createTestComponent(html);
         tick();
  ...
  describe('Custom config', () => {
    let config: Ng2vPaginationConfig;

    beforeEach(() => { TestBed.configureTestingModule({imports: [Ng2vPaginationModule.forRoot()]}); });

    beforeEach(inject([Ng2vPaginationConfig], (c: Ng2vPaginationConfig) => {
      config = c;
    ...
    it('should initialize inputs with provided config', () => {
      const fixture = TestBed.createComponent(Ng2vPagination);
      fixture.detectChanges();
  ...
  describe('Custom config as provider', () => {
    let config = new Ng2vPaginationConfig();
    ...
    beforeEach(() => {
      TestBed.configureTestingModule(
          {imports: [Ng2vPaginationModule.forRoot()], providers: [{provide: Ng2vPaginationConfig, useValue: config}]});
    });
