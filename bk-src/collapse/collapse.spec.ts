...
import {Ng2vCollapseModule} from './collapse.module';
...
describe('ng2v-collapse', () => {
  let html = `<div [ng2vCollapse]="collapsed">Some content</div>`;

  beforeEach(() => {
    TestBed.configureTestingModule({declarations: [TestComponent], imports: [Ng2vCollapseModule]});
  ...
  it('should allow toggling collapse from outside', () => {
    html = `
      ...
      <div [ng2vCollapse] #collapse="ng2vCollapse"></div>`;
